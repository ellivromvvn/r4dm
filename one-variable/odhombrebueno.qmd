...
The first 6 rows of the data set are shown in @tbl-cw.
...
The mean, standard deviation, minimum, and maximum of `weight` and `Time` and the frequency distribution of `Diet` are shown in @tbl-summary. There is a total of 578 observations.
...
A visualization of the `weight` is shown in @fig-viz.
